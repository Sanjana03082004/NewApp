...
public final class ActivityMain3Binding implements ViewBinding {
  ...
  private ActivityMain3Binding(@NonNull RelativeLayout rootView,
      @NonNull ImageView appIconImageView, @NonNull Button continueButton,
      @NonNull TextView descriptionTextView, @NonNull CheckBox termsCheckBox,
  ...
  public static ActivityMain3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain3Binding((RelativeLayout) rootView, appIconImageView, continueButton,
          descriptionTextView, termsCheckBox, titleTextView);
    }
