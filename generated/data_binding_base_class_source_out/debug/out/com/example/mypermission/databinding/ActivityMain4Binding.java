...
public final class ActivityMain4Binding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvUsageStats;

  private ActivityMain4Binding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvUsageStats) {
    this.rootView = rootView;
    this.rvUsageStats = rvUsageStats;
  }
  ...
  public static ActivityMain4Binding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.rvUsageStats;
      RecyclerView rvUsageStats = ViewBindings.findChildViewById(rootView, id);
      if (rvUsageStats == null) {
        break missingId;
      }

      return new ActivityMain4Binding((LinearLayout) rootView, rvUsageStats);
    }
